    ...
    <body>
         <div class="maindiv">
             <div class="innerdiv">
                ...
                <h2 class="notice">Notice : <%=session.getAttribute("dntitle")%></h2>
                <div class="noticeid"><b>NID</b> :<%=session.getAttribute("dnid")%></div>
                <div id="date"></div>
                
                <p class="noticebody">
                     <%=session.getAttribute("dnbody")%>
                </p>
            </div>
          </div>
                <a href=javascript:document.submitForm.submit()><input type="button" value="Back"></a><a href="editnotice.jsp"><input type="button" value="Edit"></a>
